...
This is the Repository that we will be using to build our Software-engineering Project. Welcome Mates.
...
4. The branch naming convention should follow the pattern `feature-name/specific_thing_that_it_is_for`. (eg. `feature/login`, `bugfix/signout-form`)
...
9. Once the commits are made, push the local changes to github using `git push`. 
...
Made with ❤ since 2023 in Ethiopia,  
